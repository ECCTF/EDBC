...
int MontgomeryLadderStep(projectPoint P1, projectPoint P2, projectPoint P3, 
	projectPoint &P4, projectPoint &P5, big &ConstantA);
int MontgomeryLadderDoubleStep(projectPoint P2,
	projectPoint &P4, big &ConstantA);